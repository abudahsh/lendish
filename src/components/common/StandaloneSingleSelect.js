...
class StandaloneSingleSelect extends Component {
  constructor(props) {
    super(props);
...
StandaloneSingleSelect.propTypes = {
  data: PropTypes.array.isRequired,
  value: PropTypes.object,
  title: PropTypes.string
};

StandaloneSingleSelect.defaultProps = {
  value: null
};
...
export default StandaloneSingleSelect;
